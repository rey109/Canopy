  ...
  return (
    <div className="animate-fade-in space-y-6">
      <div>
        ...
        <h1 className="mt-1 text-2xl font-bold">Ringkasan Organisasi</h1>
        <p className="mt-1 text-sm text-[var(--text-secondary)]">Pantau performa proker, struktur, persetujuan pusat, dan serah terima kepengurusan.</p>
      </div>
