...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-[#0f172a] relative overflow-hidden font-sans select-none">
      ...
      <div className="w-full max-w-4xl mb-4 flex items-center justify-between z-10">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-xs font-medium text-slate-400 hover:text-white transition-colors bg-slate-800/60 px-3 py-1.5 rounded-lg border border-slate-700/60 backdrop-blur-md"
        >
      ...
      <div className="w-full max-w-4xl min-h-[560px] bg-[#1e293b] rounded-3xl shadow-2xl border border-slate-700/60 overflow-hidden flex flex-col md:flex-row relative z-10 animate-modal-pop">
        
        {/* LEFT SIDE: Brand & Carousel Slider */}
        <div className="w-full md:w-1/2 bg-gradient-to-br from-[#1e293b] via-[#0f172a] to-[#1e1b4b] p-8 md:p-10 flex flex-col justify-between relative border-b md:border-b-0 md:border-r border-slate-700/40 overflow-hidden">
          ...
          <div className="flex items-center gap-3 z-10">
            ...
            <div>
              <h2 className="font-bold text-lg text-white tracking-wide">Canopy</h2>
              <p className="text-[11px] text-slate-400">Platform Manajemen OSIS</p>
            </div>
          </div>
        ...
        <div className="w-full md:w-1/2 bg-white text-slate-800 p-8 md:p-12 flex flex-col justify-center">
          ...
          <div className="mb-8">
            ...
            <p className="text-xs text-slate-500 mt-2">
              Silakan masukkan kredensial Anda untuk mengakses portal OSIS.
            </p>
          </div>
